...
// let  progressEn = document.querySelector(".progressE");

// let changeProgressE = (progressE) => {
//   progressEn.style.width = `${progressE}%`;
// };

// /* change progress after 1 second (only for showcase) */
// setTimeout(() => changeProgressE(22), 500);
// setTimeout(() => changeProgressE(45), 1000);
// setTimeout(() =>changeProgressE(85), 4600);
// // setTimeout(() => changeProgressE(98), 5266);
